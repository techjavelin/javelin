...
const ROLE_CAPS: Record<string,string[]> = {
  'admin': ['HUB.VIEW_ORG_DASH','HUB.VIEW_ENGAGEMENT','HUB.VIEW_PUBLISHED_FINDINGS','HUB.VIEW_DRAFT_FINDINGS','HUB.DOWNLOAD_ARTIFACT','HUB.MANAGE_ORG_USERS','HUB.REQUEST_SERVICE'],
  'client-hub-admin': ['HUB.VIEW_ORG_DASH','HUB.VIEW_ENGAGEMENT','HUB.VIEW_PUBLISHED_FINDINGS','HUB.DOWNLOAD_ARTIFACT','HUB.MANAGE_ORG_USERS','HUB.REQUEST_SERVICE'],
  'client-hub-manager': ['HUB.VIEW_ORG_DASH','HUB.VIEW_ENGAGEMENT','HUB.VIEW_PUBLISHED_FINDINGS','HUB.DOWNLOAD_ARTIFACT','HUB.REQUEST_SERVICE'],
