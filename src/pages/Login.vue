...
<template>
  <div class="terminal" style="min-height:100vh; display:flex; flex-direction:column; justify-content:center; align-items:center; background:#181818;">
    <div class="terminal-header" style="margin-bottom:2rem;">
